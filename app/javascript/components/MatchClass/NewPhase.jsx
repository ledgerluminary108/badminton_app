...
const NewPhase = ({
  ...
  const { matchType, tableCount, numberOfPlayers, selectedPlayers, tables } =
    formData;
  ...
  const handleTableChange = (e, index, rowIndex, colIndex) => {
    ...
    tables[index][rowIndex][colIndex] = e.target.value;
    tables[index][colIndex][rowIndex] = e.target.value;
